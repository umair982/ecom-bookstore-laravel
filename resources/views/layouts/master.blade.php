...
<!-- Mirrored from kodeforest.net/html/books/library/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Sep 2021 10:11:49 GMT -->
<head>
<meta charset="utf-8">
...
<!-- Boostrap Slider -->
<link href="{{url('/css/bootstrap-slider.css')}}" rel="stylesheet">
<!-- Widgets -->
...
<link rel="stylesheet" type="text/css" href="{{url('/css/bookblock.css')}}" />
...
<script src="{{url('/js/jquerypp.custom.js')}}"></script>
<script src="{{url('/js/jquery.bookblock.js')}}"></script>
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&amp;sensor=false"></script>
<script src="{{url('/js/functions.js')}}"></script>
</body>

<!-- Mirrored from kodeforest.net/html/books/library/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Sep 2021 10:18:50 GMT -->
</html>